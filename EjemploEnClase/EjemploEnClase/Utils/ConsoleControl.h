...
private:
	//Nomes s'hauria de tenir un de aquestes funcions en un projecte
...
public:
	...
	//Si es criden aquestes fucions a varias parts pot fer que colisioni amb si mateix
	//Per utilitzar-ho sense problemes s'ha de fer mutex.lock() i mutex.unlock(); abans i despres de utilitzar-ho
